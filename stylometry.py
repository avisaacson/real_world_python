...
def word_length_test(words_by_author, len_shortest_corpus):
	"""Plot word length frequency by author, truncated to shortest corupus length."""
	...
	for i, author in enumerate(words_by_author):
		...
		by_author_length_freq_dist[author].plot(15, linestyle=LINES[1], label=author, title="Word Length")
	plt.legend()
